...
export default function Quote({text, author}: Props) {
    return (
        <div className={"flex flex-col max-w-[75%] p-2"}>
            <div className={"flex"}>
                <svg width="20px" height="20px" className={"fill-amber dark:fill-green"} viewBox="0 0 48 48"
                ...
                <h1 className={"text-lg sm:text-xl md:text-2xl px-2 md:px-4 text-center italic font-semibold uppercase text-navy dark:text-white"}>
                    {text}
                </h1>
                <svg width="20px" height="20px" className={"translate-y-8 md:translate-y-0 rotate-180 fill-amber dark:fill-green"}
            ...
            <p className={"text-sm sm:text-base md:text-lg px-2 md:px-4 text-center italic uppercase text-navy dark:text-white"}>
                {author}
            </p>
        </div>
